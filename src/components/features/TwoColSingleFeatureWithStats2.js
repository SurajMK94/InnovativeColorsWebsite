...
const Subheading = tw(SubheadingBase)`text-center md:text-left text-lg`;
const Heading = tw(
  SectionHeading
...
const DecoratorBlob = styled(SvgDotPattern)(props => [
  tw`w-20 h-20 absolute right-0 bottom-0 transform translate-x-1/2 translate-y-1/2 fill-current -z-10`
]);
...
export default ({
  ...
  heading = (
    <>
      We have been doing this <wbr/> since <span>1999.</span>
    </>
  ),
